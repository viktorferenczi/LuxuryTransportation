        ...
        <div className='services'>
            ...
            <div style={{marginTop:"3rem"}}>
                ...
                <div style={{display:'flex',flexDirection:'row', justifyContent:'space-evenly'}}>
                    <div style={{backgroundColor: "#37393d",
    boxShadow: '12px 12px 2px 1px rgba(32, 32, 32, 0.747)', width:"40rem", height:"10rem"}}>
                    ...
                    <div style={{backgroundColor: "#37393d",
    boxShadow: '12px 12px 2px 1px rgba(32, 32, 32, 0.747)', width:"40rem"}}>
